So you've started using `bruty` and want to show your gratitude to the project,
...
* [Open an issue](https://github.com/lyz-code/bruty/issues/new) if you encounter
    any bug or to let us know if you want a new feature to be implemented.
* Spread the word about the program.
* Review the [documentation](https://lyz-code.github.io/bruty) and try to improve
    it.

# I know how to program in Python

If you have some python knowledge there are some additional ways to contribute.
We've ordered the [issues](https://github.com/lyz-code/bruty/issues) in
[milestones](https://github.com/lyz-code/bruty/milestones), check the issues in
the smaller one, as it's where we'll be spending most of our efforts. Try the
[good first
issues](https://github.com/lyz-code/bruty/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22),
...
[documentation](https://lyz-code.github.io/bruty) of the project, so think if
...
policy](https://github.com/lyz-code/bruty/security/policy) instead.**

To make it as simple as possible for us to help you, please include the output
of the following call in your issue:

```bash
python -c "import bruty.version; print(bruty.version.version_info())"
```

or if you have `make` installed, you can use `make version`.

Please try to always include the above unless you're unable to install `bruty` or know it's not relevant to your question or
feature request.

# Pull Requests

*bruty* is released regularly so you should see your
...
wanted"](https://github.com/lyz-code/bruty/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)
label on github.
...
* Clone your fork and go into the repository directory:
    ...
    ```bash
    git clone git@github.com:<your username>/bruty.git
    cd bruty
    ```
...
* Install bruty, dependencies and configure the
    pre-commits:
...
* Fix formatting and imports: bruty uses
...
We'd love you to contribute to *bruty*!
